 ...
 * This file demonstrates how to integrate Ethersmart with a web frontend
 */

// For React/Vue/Angular applications
export class EthersmartClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EthersmartClient(provider, contractAddress);
